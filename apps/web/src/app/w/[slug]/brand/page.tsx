 ...
 * BrandConfigForm client island. All workspace members can view; only
 * owner/admin/editor can save (enforced server-side in saveBrandConfigAction).
 *
 * Security (T-03-04-01):
 * - requireWorkspace gates access (any member, including viewer).
...
export default async function BrandPage({ params }: BrandPageProps) {
  ...
  // requireWorkspace: all roles (including viewer) can access brand settings page
